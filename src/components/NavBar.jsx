...
const NavBar = ({ fixed }) => {
      ...
      //const NavItems = ['Mercury', 'Venus', 'Earth', 'Mars', 'Jupiter', 'Saturn', 'Uranus', 'Neptune']
      return (
        <>
            ...
            <div className="container px-2 mx-auto flex flex-wrap items-center justify-between">
              <div className="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
               ...
               The planets
                ...
                >
                  <img src="./src/assets/icon-hamburger.svg" alt="hamburger" className="w-8"/>
                </button>
              </div>
              <div
                className={
              ...
              >
                ...
                {NavItems.map((item, index) => {
                  return (
                    <li className="nav-item flex justify-between py-4 lg:py-0 border-t border-t-slate-600  lg:border-0 items-center" key={index}>
                    <div className="left flex items-center">
                    <div className="rounded-full w-6 h-6 lg:hidden" style={{backgroundColor: NavItems[index].color}}>
                      </div>
                      <Link
                      ...
                      <div className="lg:hidden">
                        <img src="../src/assets/icon-chevron.svg" alt="chevron" />
                      </div>                
